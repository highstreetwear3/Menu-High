...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const links = {
        whatsapp: 'https://wa.me/573181800027',
        instagram: 'https://www.instagram.com/highstreetwear.col?igsi=MTFwM3JtazNoaThreg%3D%3D&utm_source=qr',
        tiktok: 'https://www.tiktok.com/@highstreetwear.col?_r=1',
        google: 'https://g.page/r/CWi-dKpGpyrxECE/review'
    };
    ...
    if (menuItemsArray[2]) menuItemsArray[2].href = links.tiktok;
    if (menuItemsArray[3]) menuItemsArray[3].href = links.google;
});
